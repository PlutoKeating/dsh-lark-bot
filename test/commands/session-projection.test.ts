...
async function fixture(admins: string[] = []) {
  ...
  const bridge = {
    ...
    bindConfirmed: vi.fn(async () => undefined),
  ...
  const access = { isAdmin: (id: string | undefined) => !!id && admins.includes(id) } as AccessManager;
