...
| 功能组合 | 八项能力组合（Guardian / 多角色 / 多机器人交接 / 并行 / 归档 / 跨会话通知 / 对话内模型密钥 / 计划门禁） | 同类最全，且为唯一「dsh 崩溃后飞书仍叫得应」方案 |
...
- 八个差异化能力：安全网守护 / 多角色 Agent / 多机器人可信交接 / 并行多任务 / 会话归档 / 跨会话通知 / 对话内模型密钥管理 / 计划门禁
...
- B：DeepSeek Harness 连接飞书全教程：扫码即用、崩溃也能自救，八项能力一次讲清
...
> 5. 会话归档：/archive、/retention 自动保留策略，会话列表不烂掉；
> 6. 跨会话主动通知：A 群跑完，主动发到 B 群并 @ 你；
> 7. 对话内管理模型和密钥：/model、/providers、/key 全程在聊天里完成；
> 8. 计划门禁：完整计划先发出，批准后才执行关键动作。
>
> **安全性**
...
> 扫码即用，安装只要两条命令……（展开八个能力，重点讲安全网守护）…… 特别提醒：官方从不提供 exe，
> 别下任何「下载双击运行」的版本。
